...
class RegisterForm(FlaskForm):
    ...
    r1_img=Markup(f'<img src="https://avatars.dicebear.com/api/adventurer/{r1}.svg" style="height:75px">')
    r2_img=Markup(f'<img src="https://avatars.dicebear.com/api/adventurer/{r2}.svg" style="height:75px">')
    r3_img=Markup(f'<img src="https://avatars.dicebear.com/api/adventurer/{r3}.svg" style="height:75px">')
    r4_img=Markup(f'<img src="https://avatars.dicebear.com/api/adventurer/{r4}.svg" style="height:75px">')
